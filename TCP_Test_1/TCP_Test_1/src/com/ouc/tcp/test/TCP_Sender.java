...
public class TCP_Sender_RDT22 extends TCP_Sender_ADT {
	
	private TCP_PACKET tcpPack;//待发送的TCP数据报
	private volatile int flag = 0;
	
	//构造函数
	public TCP_Sender_RDT22() {
		super();
	...
	public void rdt_send(int dataIndex, int[] appData) {
		...
		tcpH.setTh_sum(CheckSum_RDT22.computeChkSum(tcpPack));
	...
	@Override
	//接收到ACK/NACK报文：检查校验和，将确认号插入ack队列
